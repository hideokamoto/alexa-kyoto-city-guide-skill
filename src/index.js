...
const languageStrings = {
  en: {
    translation: {
      ...
      HELP:
        'Say about, to hear more about the city, or say recommend a temples, or say, go outside.',
      ABOUT:
        'Kyoto is one of the most traditional city in Kyoto.There are many temple.',
      ...
      RESTAURANTS: [
        {
          ...
          DESCRIPTION:
            'A cozy and popular spot for breakfast.  Try the blueberry french toast!'
        }
      ],
      TEMPLES: [
        {
          ...
          ADDRESS: '',
          DESCRIPTION:
            '清水寺は、京都府京都市東山区清水にある寺院。山号は音羽山。本尊は千手観音、創立者は延鎮である。'
        },
        {
          NAME: '金閣寺',
          DISTANCE: '0',
          ADDRESS: '',
          DESCRIPTION:
            '鹿苑寺は、京都市北区にある臨済宗相国寺派の寺。建物の内外に金箔を貼った3層の楼閣建築である舎利殿は金閣、舎利殿を含めた寺院全体は金閣寺として知られる。相国寺の山外塔頭寺院である'
        },
        {
          NAME: '銀閣寺',
          DISTANCE: '0',
          ADDRESS: '',
          DESCRIPTION:
            '東山慈照寺は、京都府京都市左京区にある、臨済宗相国寺派の寺院。相国寺の境外塔頭である。室町時代後期に栄えた東山文化を代表する建築と庭園を有する。'
        },
        {
          NAME: '知恩院',
          DISTANCE: '0',
          ADDRESS: '',
          DESCRIPTION:
            '知恩院は、京都府京都市東山区にある浄土宗総本山の寺院。徳川将軍家から庶民まで広く信仰を集め、今も京都の人々からは親しみを込めて「ちよいんさん」「ちおいんさん」と呼ばれている。'
        }
      ]
    }
  }
  ...
  restaurants: [
    {
      ...
      meals: 'lunch, cafe',
      description:
        'The Kaboku way is to allow customers to prepare their own tea. Teatime begins with the leisurely process of preparing the tea using a kyusu teapot.'
    },
    {
      name: 'Tenkaippin main store',
      address:
        'Mezonsirakawa, 94, Ichijoji Tsukudacho, Sakyo-ku Kyoto-shi, Kyoto',
      phone: '+81-75-722-0955',
      meals: 'lunch, dinner',
      description:
        'Tenkaippin is a Japanese restaurant chain specializing in ramen noodles. The first restaurant was opened in Kyoto in 1981'
    },
    {
      ...
      meals: 'lunch, dinner',
      description:
        'STorisei main store is the Izakaya (Japanese Style Pub) remodeled one house of Shinsei’s sake breweries. What we pour into a cup from the tank at the center of the spacious first floor and serve is Kuradashi Nama-genshu, which is very popular sake. '
    }
  ],
  temples: [
    {
      name: 'Kiyomizu-dera',
      description:
        'Kiyomizu-dera, officially Otowa-san Kiyomizu-dera, is an independent Buddhist temple in eastern Kyoto. The temple is part of the Historic Monuments of Ancient Kyoto  UNESCO World Heritage site. It was one of 20 finalists for the New7Wonders of the World. ',
      distance: '0'
    },
    {
      name: 'Ginkaku-ji',
    ...
    },
    {
      name: 'Bukkō-ji',
      description:
        "Bukkō-ji , also known as the 'Temple of the Buddha's Light', was originally named Kosho-ji, a Jōdo Shinshū temple in the Yamashina ward of Kyoto, which later moved to the heart of Kyoto.",
      distance: '38'
    }
  ]
}
...
const handlers = {
  ...
  CoffeeIntent: function () {
    ...
    var say =
      'For a great coffee shop, I recommend, ' +
      restaurant.name +
  ...
  LunchIntent: function () {
    ...
    var say =
      'Lunch time! Here is a good spot. ' +
      restaurant.name +
      '. Would you like to hear more?'
    this.response.speak(say).listen(say)
    this.emit(':responseReady')
  ...
  DinnerIntent: function () {
    ...
    var say =
      'Enjoy dinner at, ' + restaurant.name + '. Would you like to hear more?'
    this.response.speak(say).listen(say)
    this.emit(':responseReady')
  },
  ...
  TempleIntent: function () {
    ...
    var say = 'Try ' + attraction.name + '.' + attraction.description
